...
Our method is based on B-reps of meshes with geometry connectivity (e.g., halfedge \cite{mcguire2000half}). We embed P-rep of faces into the B-rep, forming a hybrid representation, which allows us to take the advantage of both representations for robustness and efficiency. This hybrid representation requires only one-time conversion from B-rep to P-rep in intersection areas of meshes.
